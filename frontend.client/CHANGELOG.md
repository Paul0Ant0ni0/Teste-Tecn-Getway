...
- Create Angular project with ng: `ng new frontend.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `frontend.client.esproj`).
